...
<fieldset  class ="izap_admin_fieldset">
  ...
  <fieldset class ="izap_admin_fieldset">
    <legend><?php echo elgg_echo('izap-videos:adminSettings:sharing_settings'); ?></legend>

     <p>
      <label><?php echo elgg_echo('izap_videos:adminSettings:izap_enable_socialnetworks');?></label>
      <?php
      echo elgg_view('input/radio', array(
      'name' => 'params[izap_enable_socialnetworks]',
      'align' => 'horizontal',
      'options' => array(
            elgg_echo('izap-bridge:yes') => 'yes',
            elgg_echo('izap-bridge:no') => 'no',
      ),
      'value' => izapAdminSettings_izap_videos('izap_enable_socialnetworks', 'yes'),
      ));
      ?>
  </p>
	<p>
      <label><?php echo elgg_echo('izap_videos:adminSettings:izap_enable_favorite');?></label>
      <?php
      echo elgg_view('input/radio', array(
      'name' => 'params[izap_enable_favorite]',
      'align' => 'horizontal',
      'options' => array(
            elgg_echo('izap-bridge:yes') => 'yes',
            elgg_echo('izap-bridge:no') => 'no',
      ),
      'value' => izapAdminSettings_izap_videos('izap_enable_favorite', 'yes'),
      ));
      ?>
  </p>
	<p>
      <label><?php echo elgg_echo('izap_videos:adminSettings:izap_enable_embedcode');?></label>
      <?php
      echo elgg_view('input/radio', array(
      'name' => 'params[izap_enable_embedcode]',
      'align' => 'horizontal',
      'options' => array(
            elgg_echo('izap-bridge:yes') => 'yes',
            elgg_echo('izap-bridge:no') => 'no',
      ),
      'value' => izapAdminSettings_izap_videos('izap_enable_embedcode', 'yes'),
      ));
      ?>
  </p>
  </fieldset>
