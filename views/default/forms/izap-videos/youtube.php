...
$form .= IzapBase::input('dropdown', array('input_title' => elgg_echo('izap-videos:youtube:categories'),
            'name' => 'attributes[youtube_cats]',
            'value' => $form_values->youtube_cats,
            'options_values' => IzapGYoutube::getYoutubeCategories()));
