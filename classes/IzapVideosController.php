...
class IzapVideosController extends IzapController {
  ...
  public function actionYoutube() {
    ...
    $this->page_elements['filter'] = '';
    $this->page_elements['title'] = 'Add youtube video';
    $params['token'] = $tokenArray['token'];
    $params['action'] = $tokenArray['url'] . '?nexturl=' . elgg_get_site_url() . '/videos/youtube';
    $this->render('forms/' . GLOBAL_IZAP_VIDEOS_PLUGIN . '/youtube', $params);
  }
